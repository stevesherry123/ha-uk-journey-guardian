...
The credentials are entered into Home Assistant's integration setup. They must
not be placed in YAML examples, source files, logs, screenshots, or issue reports.
