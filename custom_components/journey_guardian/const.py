...
CONF_STATION_ACCESS_PROFILES = "station_access_profiles"
CONF_STATION_ACCESS_FALLBACK_MINUTES = "station_access_fallback_minutes"
CONF_STATION_ACCESS_MINIMUM_MINUTES = "station_access_minimum_minutes"
CONF_TRANSPORTAPI_APP_ID = "transportapi_app_id"
CONF_TRANSPORTAPI_APP_KEY = "transportapi_app_key"
CONF_LIVE_RAIL_PROVIDER = "live_rail_provider"
...
DEFAULT_STATION_ACCESS_MINIMUM_MINUTES = 0
DEFAULT_DAILY_API_LIMIT = 30
DEFAULT_URGENT_API_RESERVE = 3
DEFAULT_LIVE_RAIL_PROVIDER = "transportapi"
DEFAULT_LIVE_NOTIFICATIONS_ENABLED = False
DEFAULT_AUTOMATIC_LIVE_RAIL_ENABLED = False
...
SERVICE_REVIEW_RAIL_NOW = "review_rail_now"
...
AUTO_RAIL_STORAGE_KEY = f"{DOMAIN}.automatic_rail_ledger"
AUTO_RAIL_STORAGE_VERSION = 1
